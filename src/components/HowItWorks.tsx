    ...
    <section id="how-it-works" className="py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <ol className="relative max-w-2xl">
          <div
            className="absolute left-[15px] top-2 bottom-2 w-px bg-paper-line"
            aria-hidden
          />
          {steps.map((step, i) => (
            <li key={step.title} className="relative pl-12 pb-12 last:pb-0">
              <span className="absolute left-0 top-0 w-8 h-8 rounded-full border border-ink/20 bg-paper flex items-center justify-center text-sm font-medium text-ink">
                {i + 1}
              </span>
