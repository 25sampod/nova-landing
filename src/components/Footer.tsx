...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--paper-line)] py-16">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid sm:grid-cols-2 md:grid-cols-[1.4fr_1fr_1fr_1fr] gap-10">
          <div>
            <p className="font-display font-semibold text-lg text-[var(--ink)] mb-3">
              NOVA
            </p>
            <p className="text-sm text-[var(--ink)]/55 max-w-xs leading-relaxed">
          ...
          {Object.entries(footerLinks).map(([heading, links]) => (
            <div key={heading}>
              <p className="text-sm font-medium text-[var(--ink)] mb-4">{heading}</p>
        ...
        <div className="mt-14 pt-6 border-t border-[var(--paper-line)] flex flex-col sm:flex-row justify-between gap-4">
